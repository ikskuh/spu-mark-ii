...
pub const mnemonics = [_]Mnemonic{
    ...
    Mnemonic{ .name = "get", .argc = 0, .instruction = .{ .condition = .always, .input0 = .pop, .input1 = .zero, .command = .get, .output = .push, .modify_flags = false } },
    Mnemonic{ .name = "set", .argc = 0, .instruction = .{ .condition = .always, .input0 = .pop, .input1 = .pop, .command = .set, .output = .discard, .modify_flags = false } },
