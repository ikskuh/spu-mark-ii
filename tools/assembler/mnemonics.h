...
MNEMONIC(replace, 1, INPUT_ARG, INPUT_POP, CMD_COPY, OUTPUT_PUSH, 0)
...
// register access
MNEMONIC(ipget, 0, INPUT_ZERO, INPUT_ZERO, CMD_IPGET, OUTPUT_PUSH, 0)
MNEMONIC(ipget, 1, INPUT_ARG, INPUT_ZERO, CMD_IPGET, OUTPUT_PUSH, 0)
...
MNEMONIC(neg, 0, INPUT_ZERO, INPUT_POP, CMD_SUB, OUTPUT_PUSH, 0)
...
MNEMONIC(bswap, 0, INPUT_POP, INPUT_ZERO, CMD_BSWAP, OUTPUT_PUSH, 0)

// Comparison
MNEMONIC(cmp, 0, INPUT_POP, INPUT_POP, CMD_SUB, OUTPUT_DISCARD, 1)
MNEMONIC(cmp, 1, INPUT_POP, INPUT_ARG, CMD_SUB, OUTPUT_DISCARD, 1)
MNEMONIC(cmpp, 1, INPUT_PEEK, INPUT_ARG, CMD_SUB, OUTPUT_DISCARD, 1)
