...
-- Module  Version: 1.2
--/usr/local/diamond/3.11_x64/ispfpga/bin/lin64/scuba -w -n embedded_function_block -lang vhdl -synth lse -bus_exp 7 -bb -type efb -arch xo3c00f -freq 12 -ufm -ufm_ebr 2045 -mem_size 1 -ufm_0 -wb -dev 6900 
...
entity embedded_function_block is
    port (
...
end embedded_function_block;

architecture Structure of embedded_function_block is
...
begin
    ...
    EFBInst_0: EFB
        ...
        UFM_INIT_ALL_ZEROS=> "ENABLED", UFM_INIT_START_PAGE=>  2045, 
        UFM_INIT_PAGES=>  1, DEV_DENSITY=> "6900L", EFB_UFM=> "ENABLED", 
        ...
        EFB_I2C1=> "DISABLED", EFB_WB_CLK_FREQ=> "12.0")
