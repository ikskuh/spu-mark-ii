...
MNEMONIC(int,    2, INPUT_ARG,  INPUT_ARG,  CMD_INT,    OUTPUT_DISCARD,  0)
MNEMONIC(setint, 1, INPUT_ARG,  INPUT_ZERO, CMD_SETINT, OUTPUT_DISCARD,  0)

// MMU
MNEMONIC(map,    2, INPUT_ARG,  INPUT_ARG,  CMD_MAPMMU, OUTPUT_DISCARD,  0)
MNEMONIC(map,    1, INPUT_ARG,  INPUT_POP,  CMD_MAPMMU, OUTPUT_DISCARD,  0)
MNEMONIC(map,    0, INPUT_POP,  INPUT_POP,  CMD_MAPMMU, OUTPUT_DISCARD,  0)
